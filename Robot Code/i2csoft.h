...
#define SCLPORT	PORTB	//TAKE PORTC as SCL OUTPUT WRITE
#define SCLDDR	DDRB	//TAKE DDRC as SCL INPUT/OUTPUT configure

#define SDAPORT	PORTB	//TAKE PORTC as SDA OUTPUT WRITE
#define SDADDR	DDRB	//TAKE PORTC as SDA INPUT configure

#define SDAPIN	PINB	//TAKE PORTC TO READ DATA
#define SCLPIN	PINB	//TAKE PORTC TO READ DATA

#define SCL	PB6		//PORTD.0 PIN AS SCL PIN
#define SDA	PB7		//PORTD.1 PIN AS SDA PIN
